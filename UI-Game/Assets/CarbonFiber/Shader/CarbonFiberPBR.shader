Shader "CarbonFiber/CarbonFiberPBR" {
	Properties {
		...
		_ReflectionPower("Reflect Power", Range(0,1)) = 0.1
		_Blend("Reflect Blend", Range(0.0,1.0)) = 0.6
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandardSpecular o) {
			...
			o.Albedo = c.rgb;
			o.Specular = lerp(FiberCol*c.a*_Gloss*(22*_Blend), _SpecularColor+ c.a*_Gloss, _ReflectionPower);
